    ...
    public ResponseEntity<ResponseMessage> changePasswordRequest(ChangePasswordRequestDTO dto) {
        ...
        try {
            ...
            String emailContent = "<style>\r\n" + //
                    ...
                    + "<img style=\"width: 150px; height: 100px;\" src=\"https://raw.githubusercontent.com/sptech-nimbus/server/24a82d236b5f8a733eb67b08349e0c1611239721/users_ms/src/main/java/com/user/user/utils/img/logo.svg\" alt=\"\">"
                    + "</div>"
                    ...
                    + "</div>"
                    + "<img style=\"margin-top: 30px; width: 318px; height: 150px; margin-left: 20px\" src=\"https://raw.githubusercontent.com/sptech-nimbus/server/24a82d236b5f8a733eb67b08349e0c1611239721/users_ms/src/main/java/com/user/user/utils/img/footer.svg\" alt=\"\">"
                    + "</div>"
                    + "</div>";
