    ...
    public ResponseEntity<ResponseMessage> changePasswordRequest(ChangePasswordRequestDTO dto) {
        ...
        try {
            ...
            String emailContent = "<style>\r\n" + //
                    ...
                    + "<div style=\"margin-left: 98px; margin-top: 15px;\">"
                    + "<img style=\"width: 130px; height: 100px;\" src=\"https://raw.githubusercontent.com/sptech-nimbus/server/dev/users_ms/src/main/java/com/user/user/utils/img/logo-email.png\" alt=\"\">"
                    + "</div>"
